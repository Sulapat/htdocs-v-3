...
class PHPMailer
{
    ...
    protected function sendmailSend($header, $body)
    {
        ...
        // @see https://github.com/PHPMailer/PHPMailer/issues/2298
        ...
        foreach ($hosts as $hostentry) {
            ...
            if ($this->smtp->connect($prefix . $host, $port, $this->Timeout, $options)) {
                try {
                    ...
                    //* it's not disabled
                    //* we are not connecting to patineer.co.th
     ...
     * Returns 'patineer.co.th.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return 'patineer.co.th.localdomain';
        }
