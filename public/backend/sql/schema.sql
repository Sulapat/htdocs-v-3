...
-- ============================================================
-- ตาราง article_view_logs — เก็บ log การเข้าชมบทความแต่ละครั้ง
-- ใช้คู่กับ registerArticleView() ใน api_i18n.php
-- กันนับซ้ำ: IP เดิม + บทความเดิม ในวันเดียวกัน (ตาม CURDATE()) นับแค่ 1 ครั้ง
-- ============================================================
